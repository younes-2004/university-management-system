document.addEventListener('DOMContentLoaded', () => {
 ...
 // Modification de la fonction viewFiliere pour rediriger vers la nouvelle page
  function viewFiliere(id) {
    // Rediriger vers la page de détails avec l'ID de la filière
    window.location.href = `filiere-details.html?id=${id}`;
  }
